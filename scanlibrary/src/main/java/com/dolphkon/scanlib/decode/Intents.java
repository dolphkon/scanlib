...
public class Intents {
    ...
    public static final class Scan {
        ...
        /**
         * Comma-separated list of formats to scanlib for. The values must match the names of
         ...
         * requested the scanlib via startSubActivity(). The barcodes contents can be retrieved with
    ...
    public static final class Encode {
         ...
         * that another person can scanlib the barcode from your screen.
         */
    ...
    public static final class Share {
         ...
         * display onscreen for a friend to scanlib with their phone.
         */
