...
import com.dolphkon.scanlib.camera.BitmapLuminanceSource;
import com.dolphkon.scanlib.decode.DecodeFormatManager;
...
public final class QRCodeAnalyzeUtils {
     ...
     */
    public static void analyzeQRCode(String QRCodePicPath, CodeUtils.AnalyzeCallback analyzeCallback) {
